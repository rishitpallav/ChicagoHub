...
////////////////////////////////////////////////////////////////////////////////////
  ...
  get_all_divvy_stations_data_range(timeRange, newTimeRangeSelection, currentTimeStart, timeDiff){
    const find_stations_at = {
    ...
    return this.http.post(`${this.uri}/stations/fetch_divvy_stations_data_range`, find_stations_at, httpOptions);
