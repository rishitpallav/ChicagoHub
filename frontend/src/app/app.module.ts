...
import { HeatMapRealtimeComponent } from './components/divvy-heat-map-realtime/heat-map-realtime.component';
...
const routes: Routes = [
  ...
  { path: 'heat_map_realtime', component: HeatMapRealtimeComponent},
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    AgmCoreModule.forRoot({apiKey: 'AIzaSyD2gvsQdDQQjWLy9x6RMB66UyzeEz_eOug'+ '&libraries=visualization'}),
    FormsModule,
    NgbModule,
    MatCheckboxModule
